package com.anonymous.messaging.components;
...
public class BadgeTabLayout extends TabLayout {
    ...
    public static final class Builder {
         ...
         */
        private static final int INVALID_NUMBER = 0;//Integer.MIN_VALUE;
        ...
        @Nullable TextView mTitleTextView;

        Drawable mIconDrawable;
        Integer mIconColorFilter;
        int mBadgeCount = 0;//Integer.MIN_VALUE;
        String mTitle = "";
        ...
        private Builder(TabLayout parent, @NonNull TabLayout.Tab tab) {
            ...
            if (mView != null) {
                ...
                this.mTitleTextView = (TextView) mView.findViewById(R.id.tab_title);
            }
            ...
            if (this.mTitleTextView != null) {
                this.mTitle = mTitleTextView.getText().toString();
            }
        ...
        public Builder decrease() {
            if (mBadgeCount > 0) mBadgeCount -= 1;
            return this;
        }
